...
def add_to_google_calendar(stock_symbol: str, date: datetime) -> None:
    ...
    params = {
        ...
        "details": "Event generated by <a href='https://auraviz.app'>auraviz.app</a> \n\n"
        + "This is only the estimated date since actual dates are finalized when the earnings period nears.",
